...
33820,33820,Longmont,Vehicles Travelling North,40.149505,-105.103068,,,1,,,0
*/ 

/* 
bart field order for stops
...
CREATE TABLE `stops` (
  stop_id varchar(11) NOT NULL DEFAULT '0',
/* 
...
CREATE TABLE `trips` (
    route_id varchar(8),
    service_id VARCHAR(2),
	trip_id VARCHAR(11) PRIMARY KEY,
